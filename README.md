...
**decode-morse-code** is a database project built using `ruby` to decode a message written in morse code to words.
...
```sh
  cd my-folder
  git clone https://github.com/Pi1998/decode-morse.git
```
...
Feel free to check the [issues page](https://github.com/Pi1998/decode-morse/issues).
...
If you like this project, please support me by giving a star to this project. Feel free to visit my GitHub and review my other projects!!!
...
I thank the [Microverse](https://www.microverse.org/) for this big opportunity.
